...
return array(
    'phrase'    => array(
        'browser'           => 'tarayıcınızda görüntüleyin.',
        'unsubscribe'       => 'Bu listedeki üyeliğinizi iptal edin',
        'update'            => 'Üyeliğinizi güncelleyin.',
        'view_on'           => 'Bu mesajı',
        'view_on_browser'   => 'Bu mesajı tarayıcınızda görüntüleyin',
    ),
);
/**
 * Change Log
 ...
 * A phrase
 * A phrase.browser
 * A phrase.unsubscribe
 * A phrase.view_on
 * A phrase.view_on_browser
 *
 */